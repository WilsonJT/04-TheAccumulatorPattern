...
#
#              for k in range(r - s):  RANGE SHOULD BE "s - r"
#                  count = 0           COUNT SHOULD NOT BE DECLARED INSIDE LOOP
#                  if math.cos(r) > 0: SHOULD BE "math.cos(k)"
#                      count = 1       SHOULD BE "count += 1"
#                  return count        SHOULD RETURN OUTSIDE LOOP
#
#     f. The code in the "graphics accumulation" example below includes:
#            for _ in range(n):
#        What does the   _   (underscore) mean? IT MEANS A LOOP VARIABLE NOT USED IN LOOP
#
